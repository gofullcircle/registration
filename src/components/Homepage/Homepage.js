        ...
        <div className="row">
          ...
          <div className="col-12 col-md-10 col-lg-8">
            <div className="course-description">
              <div className="title-container d-flex">
                <h1 className="h1 course-title m-auto p-3">
                  <b>Go Full Circle waitlist now open</b>
                </h1>
              </div>
              <br />
              <br />
              ...
              {SHOW_WAITLIST ? (
                <>
                  ...
                  <h3>About the program:</h3>
                  <p className="intro-copy justify">
                    Introducing the Go Full Circle program, a tailor-made
                    program for local businesses to revolutionise their
                    operations and unlock environmental, social and financial
                    advantages. <br />
                    <br />
                    Embark on an eight-week journey that will equip you with the
                    knowledge, tools, and network to thrive in the circular
                    economy. Our immersive virtual course, divided into four
                    dynamic modules, will kick-start your business's
                    transformation, to take you beyond just “sustainability”.{" "}
                    <br />
                    <br />
                    Engage with a new community of likeminded people through 4
                    interactive sessions, where you'll dive deep into the
                    theories, tools and practical insights of the circular
                    economy through local, practical real-life case studies.
                    Then, armed with this newfound wisdom, you'll spend the
                    following weeks at your own pace applying these concepts to
                    your business, how to create your own network of support,
                    with shared peer to peer learning, ensuring you walk away
                    with a strategy, hands-on learning experience and a
                    community of like minded businesses to support you into the
                    future.
                    <br />
                    <br />
                    Each participant will be provided with a one-hour 1 on 1
                    session with a program facilitator to provide additional
                    assistance throughout their learning journey. 1 on 1
                    sessions are available in the second half of the program,
                    and will be confirmed on an individual basis.
                  </p>
                  <br />
                  <br />
                  <iframe
                  ...
                  <ul>
                    <li>
                      For businesses located in Melbourne, Stonnington or
                      Boroondara Council Area(s)
                    </li>
                    <li>
                      This program is designed for owners or staff with the
                      ability to implement new practices in their business
                    </li>
                    <li>
                      It has been designed predominantly for businesses from the
                      hospitality and retail sectors, however we encourage all
                    ...
                    <li>
                      This is designed to be an online experience. Participants
                      will need to have a computer or tablet with a microphone
                      and camera that can support Zoom
                    </li>
                  </ul>
                  <br />
                  <br />
                  ...
                  <div className="reason">
                    <b className="reason-header">Ignite Innovation</b>
                    <p className="reason-text">
                      Discover real and tangible circular opportunities to
                      create value and practice using the tools needed to
                      successfully implement them within your business.
                    </p>
                  </div>
                  <div className="reason">
                    <b className="reason-header">
                    ...
                    <p className="reason-text">
                      Collaborate with others and learn how to apply circular
                      design tools to real business environments, revealing
                      fresh perspectives and effective approaches to tackling
                      challenges. Forge connections with like-minded businesses
                      and local councils, forming a supportive network that
                      assists your journey towards circularity.
                    </p>
                  </div>
                  <div className="reason">
                    <b className="reason-header">
                    ...
                    <p className="reason-text">
                      Explore where and how you can apply substantial cost
                      savings through waste reduction and minimisation, or
                      create new revenue streams, while attracting and retaining
                      customers who value responsible businesses.
                    </p>
                  </div>
                  <div className="reason">
                    <b className="reason-header">Attract & Retain Top Talent</b>
                  ...
                  <div className="reason">
                    <b className="reason-header">Future-Proof Your Success</b>
                    <p className="reason-text">
                      Safeguard your supply chains and your business's
                      resilience in the face of ever-changing requirements.
                    </p>
                  </div>
                  <br />
                  <br />
                  <p className="intro-copy justify">
                    Join us in reshaping the future of business, as we empower
                    you to embrace the circular economy and propel your company
                    to better practices. Apply for the Go Full Circle program
                    today and unlock boundless possibilities for a brighter,
                ...
                <>
                  ...
                  <br />
                  <br />
                  <p className="intro-copy justify">The Go Full Circle team.</p>
